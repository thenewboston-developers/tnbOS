  ...
  const validationSchema = useMemo(() => {
    return yup.object().shape({
      ...
      total: yup
        ...
        .min(0)
        .test('total-does-not-exceed-balance', 'Total cost exceeds account balance', (total) => {
              ...
              left={
                <>
                  ...
                  <Amount
                    ...
                    amountLabel="Price"
                    bottomText={`Limits: ${offer.saleTerms.orderMin} - ${offer.saleTerms.orderMax} ${buyersIncomingAssetDisplayName}`}
                    leftAlign={true}
