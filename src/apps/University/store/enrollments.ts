...
const enrollments = createSlice({
  ...
  reducers: {
    ...
    unsetEnrollments: (state: Enrollments, {payload: courseIds}: PayloadAction<string[]>) => {
...
export const {setEnrollment, setEnrollments, unsetEnrollment, unsetEnrollments} = enrollments.actions;
