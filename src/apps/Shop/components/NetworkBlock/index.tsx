...
import Table from 'apps/Shop/components/Table';
import {Transaction, TransactionPerspective, TransactionStatus} from 'apps/Shop/types';
...
const NetworkBlock: SFC<NetworkBlockProps> = ({className, networkBlock, networkDisplayName}) => {
  ...
  }, [networkBlock, self.accountNumber]);
